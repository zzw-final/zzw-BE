...
//        Member member = (Member) result.getData();
//
//        List<Follow> followlist = followRepository.findAllByMemberOrderByFollowerNicknameAsc(member);
//        List<Member> members = new ArrayList<>();
//        List<FollowResponseDto> followResponseDtos = new ArrayList<>();
//
//        for(Follow follow : followlist){
//            Member member1 = memberRepository.findMemberById(follow.getFollowerId());
//            members.add(member1);
//        }
//
